...
const game2Element = getElementFromTemplate(`
	<header class="header">
		<button class="back">
...
const radioButtons = game2Element.querySelectorAll(`.game__answer input[type='radio']`);
const backButton = game2Element.querySelector(`.back`);

radioButtons.forEach((it) => {
	it.addEventListener(`change`, () => changeScreen(game3Element));
});
